...
const audios = ['imagination', 'addictofmagic', 'allweknow', 'dieahappyman', 'drunktext'];
const tits = ['Imagination', 'Addict Of Magic', 'All We Know', 'Die A Happy Man', 'Drunk Text'];
const artists = ['Shawn Mendes', 'Picture This', 'Chainsmokers', 'Thomas Rhett', 'Henry Moodie'];
