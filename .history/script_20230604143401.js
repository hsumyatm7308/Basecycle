...
function playado(){
    playpause.querySelector('i.fas').classList.remove('fas-play');
    playpause.querySelector('i.fas').classList.add('fas-play');
    audiosrc.play();
}

function pauseado(){
    playpause.innerHTML = ' <div id="playpause" class="playpause"><i class="fa-solid fa-play"></i></div>'
    audiosrc.pause();
}
