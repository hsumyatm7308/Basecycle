...
for(var x = 0;x < digital.length;  x++ ){


digital[x].addEventListener('click',function(){

// $('#dgid1').addClass('dgani1p1');

  dgidone.classList.add('dgani1p1')

  
        // $('#digital').click(function(){
        //   $('#dgid1').replace('dgani1p1','dganireverse1');
        // //   $('#dgid1').removeClass('dgani1p1');
        ...
        digital[x].addEventListener('click',function(){
            dgidone.classList.replace('dgani1p1','dganireverse1')
        })
});
