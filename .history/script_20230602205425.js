...
$(document).ready(function () {
    ...
    $('#digital').click(function(){
        $('.digitalcontainer').toggle(function(){
            if($('.digitalcontainer').attr('style','display:block')){
                $('#dgid1').addClass('digianirev1');
                $('#dgid2').addClass('digianirev2');
        
                $('#dgid1').remove('digiani1');
                $('#dgid2').remove('digiani2');
               }
        });
        $('#dgid1').addClass('digiani1');
        $('#dgid2').addClass('digiani2');
